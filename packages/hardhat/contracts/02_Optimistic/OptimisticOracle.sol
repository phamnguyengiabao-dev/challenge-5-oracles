...
contract OptimisticOracle {
     ...
     * @return assertionId The unique assertion ID for the newly created assertion
     */
    function assertEvent(
        string memory description,
        uint256 startTime,
        uint256 endTime
    ) external payable returns (uint256 assertionId) {
    ...
    function claimUndisputedReward(uint256 assertionId) external {
        ...
        (bool success, ) = payable(assertion.proposer).call{ value: totalReward }("");
